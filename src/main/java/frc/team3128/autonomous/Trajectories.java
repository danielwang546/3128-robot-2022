...
public class Trajectories {
    private static final DifferentialDriveVoltageConstraint autoVoltageConstraint =
            new DifferentialDriveVoltageConstraint(
                    ...
                    Constants.DriveConstants.MAX_DRIVE_VOLTAGE);

    private static final TrajectoryConfig forwardTrajConfig =
            new TrajectoryConfig(
                            Constants.DriveConstants.MAX_DRIVE_VELOCITY,
    ...
    public static Trajectory trajectorySimple =
            TrajectoryGenerator.generateTrajectory(
                    ...
                    new Pose2d(
                            Units.inchesToMeters(90), Units.inchesToMeters(0), new Rotation2d(0)),
                    forwardTrajConfig);
    ...
    public static Trajectory trajectoryLessSimple =
            TrajectoryGenerator.generateTrajectory(
                    ...
                    new Pose2d(
                            Units.inchesToMeters(50), Units.inchesToMeters(-15), new Rotation2d(0)),
                    forwardTrajConfig);
    ...
    public static Trajectory twoBallTraj =
            TrajectoryGenerator.generateTrajectory(
                    new Pose2d(0, 0, new Rotation2d(0)),
                    List.of(),
    ...
    public static Trajectory driveForwards500In =
            TrajectoryGenerator.generateTrajectory(
                    new Pose2d(0, 0, new Rotation2d(0)),
                    List.of(),

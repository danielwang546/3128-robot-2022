...
public class Constants {
    ...
    public static class ConversionConstants {
        ...
        public static final double SPARK_VELOCITY_FACTOR =
                SPARK_ENCODER_RESOLUTION / 60; // RPM to nu/s
        public static final double FALCON_NUp100MS_TO_RPM =
                10 * 60 / FALCON_ENCODER_RESOLUTION; // sensor units per 100 ms to rpm
        public static final double FALCON_NUpS_TO_RPM =
                60 / FALCON_ENCODER_RESOLUTION; // sensor units per second to rpm
    }
    ...
    public static class DriveConstants {
        ...
        public static final double ARCADE_DRIVE_RATE_LIMIT =
                2.0; // max rate of change in the forward parameter (joystick Y axis) given to
        // arcade drive
        ...
        public static final double ENCODER_DISTANCE_PER_MARK =
                WHEEL_RADIUS_METERS * 2 * Math.PI / ConversionConstants.FALCON_ENCODER_RESOLUTION;
        public static final double DRIVE_NU_TO_METER =
                ENCODER_DISTANCE_PER_MARK / DRIVE_GEARING; // meters driven per encoder tick
        public static final double DRIVE_NUp100MS_TO_MPS =
                DRIVE_NU_TO_METER * 10; // sensor units per 100 ms to m/s of drivetrain
        public static final double MAX_DRIVE_VEL_NUp100MS =
                6380
                        * ConversionConstants.FALCON_ENCODER_RESOLUTION
                        / 60
                        / 10; // max angular velocity of drivetrain (encoder, not wheel) in sensor
        // units per 100
        // ms - 6380 RPM * RESOLUTION nu/rot * 1 min/60s * 1s/(10*100ms)
        ...
        public static final double MAX_DRIVE_ACCELERATION =
                2; // m/s^2 - I don't know what this number is
        public static final double MAX_DRIVE_VOLTAGE =
                7; // volts (hopefully you could figure this out)
        ...
        public static final double RAMSETE_B =
                2; // default value - don't change unless absolutely necessary
        public static final double RAMSETE_ZETA =
                0.7; // default value - don't change unless absolutely necessary
    ...
    public static class ShooterConstants {
        ...
        public static final double LOW_kV =
                0.0017857 * 0.9; // 0.00163; //Velocity gain in PID Feed Forward
        public static final double LOW_kA =
                0.0053359 * 0.9; // 0.0349; //Acceleration gain PID Feed Forward

        public static final double HIGH_kS = 0.2; // * 0.925; //Static gain in PID Feed Forward
        public static final double HIGH_kV =
                0.0017857; // * 0.97; //Velocity gain in PID Feed Forward
        public static final double HIGH_kA =
                0.0053359; // * 0.99; //Acceleration gain PID Feed Forward
        ...
        public static final LinearSystem<N1, N1, N1> SHOOTER_CHAR =
                LinearSystemId.identifyVelocitySystem(LOW_kV, LOW_kA);
    ...
    public static class ClimberConstants {
        ...
        public static final double CLIMB_ENC_DIAG_EXTENSION =
                322000; // 6600;//same as diag extension rn // old-7850; //-7379
    ...
    public static class HoodConstants {
        ...
        public static final double kF =
                0.49072349; // 0.6134;//1.2268;//0.6134;//1.2268; //0.6134;//0.0517638;
        ...
        public static final double ENC_POSITION_CONVERSION_FACTOR =
                360.0 / HOOD_SHOOTER_GEAR_RATIO; // Multiply by this to convert encoder rotations
        // to hood
        // degrees
        ...
        public static InterpolatingTreeMap<InterpolatingDouble, InterpolatingDouble> hoodAngleMap =
                new InterpolatingTreeMap<InterpolatingDouble, InterpolatingDouble>();
    ...
    public static class VisionConstants {
        ...
        public static final double TX_THRESHOLD_INCREMENT =
                (TX_THRESHOLD_MAX - TX_THRESHOLD) / TIME_TO_MAX_THRESHOLD; // degrees per second

        public static final int ALIGN_PLATEAU_COUNT =
                10; // Number of checks at correct RPM to shoot

        public static final double BALL_TARGET_HEIGHT = 9.5 / 2;
        public static final double BALL_LL_HEIGHT = 24;
        public static final double BALL_LL_ANGLE =
                65.15 * Math.PI / 180; // 1.0; // Math.acos(21.0 / 39.0); // 1.002186; // radians
        public static final double BALL_LL_FRONT_DIST = 0; // meters, measure

        public static final double GOAL_HORIZONTAL_OFFSET =
                0; // goal of x displacement from robot to ball/target - ideally 0 but if limelight
        // not
        // center change

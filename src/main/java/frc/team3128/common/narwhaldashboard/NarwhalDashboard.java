...
public class NarwhalDashboard extends WebSocketServer {
    ...
    private static final int UPDATE_WAVELENGTH = 100;
    ...
    private static LinkedHashMap<String, Command> autoPrograms =
            new LinkedHashMap<String, Command>();

    private static HashMap<String, DashButtonCallback> buttons =
            new HashMap<String, DashButtonCallback>();
    private static HashMap<String, NumericalDataCallback> numDataCallbacks =
            new HashMap<String, NumericalDataCallback>();
    ...
    public static Command getSelectedAuto() {
        ...
        //             + "\" does not exist. Perhaps it was deleted between its selection and the
        // beginning of the autonomous period?");
        // }
    ...
    /**
     * Starts the NarwhalDashboard server. This opens it up to be able to be connected to by client
     * devices (the DS Laptop, a tablet controller, etc) and begins streaming data.
     */
    ...
    public void onOpen(WebSocket conn, ClientHandshake handshake) {
        Log.info(
                "NarwhalDashboard",
                conn.getRemoteSocketAddress().getHostName() + " has opened a connection.");
                                ...
                                for (String category : ConstantsInt.categories.keySet()) {
                                    ...
                                    for (Field field : fields) {
                                        try {
                                            ...
                                            Log.info(
                                                    "Narwhal Dashboard",
                                                    "Constant Of " + newConstant.toJSONString());
    ...
    public void onMessage(WebSocket conn, String message) {
        ...
        if (parts[0].equals("selectauto")) {
            ...
            if (programName.equals("null")) {
                ...
                Log.recoverable(
                        "NarwhalDashboard", "Auto program \"" + programName + "\" does not exist.");
            }
            ...
            if (numDataCallbacks.containsKey(key)) {
                ...
                Log.info(
                        "NarwhalDashboard",
                        "Recieved, but will not process, numerical data: " + key + " = " + data);
            }
            ...
            if (selectedLimelight.equals("null")) {
                ...
                Log.info(
                        "NarwhalDashboard",
                        "Unable to Parse Limelight Change Request from Dashboard");
            }
            ...
            if (pipelineStr.equals("null")) {
                ...
                Log.info(
                        "NarwhalDashboard",
                        "Unable to Parse Pipeline Change Request from Dashboard");
            }
